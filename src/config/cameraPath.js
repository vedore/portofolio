...
export const CAMERA_SCOPE_ENTRY_POSITION = [1.867, 4.616, 0];
...
export const MOBILE_CAMERA_SCOPE_ENTRY_POSITION = [1.867, 4.616, 0];
...
export const CAMERA_PATH = {
  desktop: {
    ...
    scopeEntry: CAMERA_SCOPE_ENTRY_POSITION,
  ...
  mobile: {
    ...
    scopeEntry: MOBILE_CAMERA_SCOPE_ENTRY_POSITION,
    target: LENS_TARGET_POSITION,
  },
};
